...
This asset is URP compatible. Simply import the included SMGP_06_URP_materials unity asset pack and let it overwrite the built-in materials. Change your project settings accordingly:

🛠️ Step 1: Set up your project to use URP
1️. In Unity, go to Edit → Project Settings → Graphics.
2️. Under Scriptable Render Pipeline Settings, assign a URP Render Pipeline Asset (you can create one via Assets → Create → Rendering → URP Asset if you don’t have one).

Your project is now running URP!

🎨 Step 2: Import URP materials
This pack includes a URP Materials Package to ensure all materials work as intended in URP.

1️. Find the SMGP_06_URP_materials.unitypackage inside the Supermarket_Gluttony_Pack folder, double click the file to import it into your project.
2. The URP versions of the materials will now be available and used.
